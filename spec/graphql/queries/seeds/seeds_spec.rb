...
RSpec.describe Types::QueryType do
  describe 'display seeds' do
    it 'can query all seeds' do
      ...
      seed1 = create(:seed, name: "Eggplant", planting_depth: "1-2 in", days_to_germinate: "5-7 days", time_to_harvest: "45-60 days", date_planted: "2021-11-23", expected_plant_height: "45-60 in", notes: "purple", sun_exposure: "full_sun", user: user1)
      create_list(:seed, 4)
      ...
      expect(result["data"]["seeds"].first["sunExposure"]).to eq(1)
    end
